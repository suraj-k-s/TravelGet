...
include('../Assets/Connection/Connection.php');
	...
	{
		$rejectid=$_GET['acid'];
		$upQry="update tbl_guide set guide_status='1' where guide_id='$rejectid'";
		if($con->query($upQry))
		{
		header("location:RejectedGuidelist.php");
		}
	}
...
<title>Travel-Get: Rejected guide list</title>
</head>
...
<br>
   ...
   <table width="200" border="1" style="margin-left: 300px;">
    ...
    <?php
	$selqry="select * from tbl_guide g inner join tbl_place p on g.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where g.guide_status='2'";
    ...
    <tr>
      ...
      <td><a href="RejectedGuidelist.php?acid=<?php echo $row['guide_id'] ?>">Accept</a></td>
    </tr>
    <?php
	}
	?>
